                                    ...
                                    <div class="account-dropdown js-dropdown bg-light-secondary">
                                        <div class="account-dropdown__body">
                                            <div class="account-dropdown__item">
                                                <a href="/metrics/new">New Metric</a>
                                            </div>
                                            <div class="account-dropdown__item">
                                                <a href="/metrics/export">Export Metrics</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    ...
                                    <div class="account-dropdown js-dropdown bg-light-secondary">
                                        <div class="account-dropdown__body">
                                            <div class="container">
                                                <form action="/metrics" method="GET" enctype="multipart/form-data">
                                                    ...
                                                    <div class="actions d-flex justify-content-around">
                                                        <a href="/metrics" class="btn btn-secondary">Reset</a>
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a class="item bg-warning" href="/metrics/{{$metric->id}}/edit"
                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="zmdi zmdi-edit text-dark"></i>
                                    </a>
                                    <form method="GET" action="/metrics/{{$metric->id}}/destroy">
                                        @csrf
